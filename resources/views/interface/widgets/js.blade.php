<script src="{{asset('interface/js/jquery.js')}}"></script>
    <script src="{{asset('interface/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('interface/js/jquery.scrollUp.min.js')}}"></script>
    <script src="{{asset('interface/js/price-range.js')}}"></script>
    <script src="{{asset('interface/js/jquery.prettyPhoto.js')}}"></script>
